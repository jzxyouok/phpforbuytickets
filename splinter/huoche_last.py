...
NC : %u5357%u660C%2CNCG

XM : %u53A6%u95E8%2CXMS
...
def login():
    loginEle = b.find_by_text(u"登录")
    if isinstance(loginEle,ElementList):
        loginEle[0].click()
    else:
        loginEle.click()    
    sleep(3)
...
if __name__ == "__main__":
    ...
    # print dir(Browser(driver_name="chrome"))
    huoche()